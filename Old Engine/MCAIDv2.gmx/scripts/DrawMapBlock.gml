...
if (argument7=="1") {draw_sprite(sprMapSpecial,0,argument0,argument1);}
if (argument7=="2") {draw_sprite(sprMapSpecial,1,argument0,argument1);}
if (argument7=="3") {draw_sprite(sprMapSpecial,2,argument0,argument1);}
if (argument7=="4") {draw_sprite(sprMapSpecial,3,argument0,argument1);}
if (argument7=="5") {draw_sprite(sprMapSpecial,4,argument0,argument1);}
}
